...
const Features = () => {
  const [isFormOpen, setIsFormOpen] = useState(false); // State untuk form booking
  ...
  return (
    <section className="h-fit bg-black  flex flex-col items-center py-20 md:py-28 md:mt-28" id="Fitur Unggulan">
      <motion.h1
        initial={{
          y: 100,
          scale: 0.8,
      ...
      <motion.button 
        ...
        className="px-8 py-4 md:px-24 border-white text-white border rounded-xl font-oswald font-bold text-base md:text-lg mt-10 md:mt-12 bg-black"
